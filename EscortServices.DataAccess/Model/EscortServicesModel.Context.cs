...
namespace EscortServices.DataAccess.Model
{
    ...
    public partial class EscortServicesEntities : DbContext
    {
        ...
        public virtual ObjectResult<Advertisement> AdvertisementPagging(ObjectParameter totalPages, Nullable<int> pageNo, Nullable<int> pageSize, string sortColumn, Nullable<bool> isAsc, Nullable<int> categoryId, Nullable<int> cityId, Nullable<int> voivodeshipId, Nullable<int> ageFrom, Nullable<int> ageTo, Nullable<int> weightFrom, Nullable<int> weightTo, Nullable<int> heightFrom, Nullable<int> heightTo, Nullable<int> breastSizeFrom, Nullable<int> breastSizeTo, Nullable<bool> isEnglish, Nullable<bool> isGerman, Nullable<bool> isRussian, Nullable<int> price1hFrom, Nullable<int> price1hTo, Nullable<int> price30minFrom, Nullable<int> price30minTo, Nullable<int> price15minFrom, Nullable<int> price15minTo, Nullable<int> priceAllNightFrom, Nullable<int> priceAllNightTo, Nullable<int> outCallsId)
        {
            ...
            var heightFromParameter = heightFrom.HasValue ?
                new ObjectParameter("HeightFrom", heightFrom) :
                new ObjectParameter("HeightFrom", typeof(int));
    
            var heightToParameter = heightTo.HasValue ?
                new ObjectParameter("HeightTo", heightTo) :
                new ObjectParameter("HeightTo", typeof(int));
    
            var breastSizeFromParameter = breastSizeFrom.HasValue ?
                new ObjectParameter("BreastSizeFrom", breastSizeFrom) :
                new ObjectParameter("BreastSizeFrom", typeof(int));
    
            var breastSizeToParameter = breastSizeTo.HasValue ?
                new ObjectParameter("BreastSizeTo", breastSizeTo) :
                new ObjectParameter("BreastSizeTo", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Advertisement>("AdvertisementPagging", totalPages, pageNoParameter, pageSizeParameter, sortColumnParameter, isAscParameter, categoryIdParameter, cityIdParameter, voivodeshipIdParameter, ageFromParameter, ageToParameter, weightFromParameter, weightToParameter, heightFromParameter, heightToParameter, breastSizeFromParameter, breastSizeToParameter, isEnglishParameter, isGermanParameter, isRussianParameter, price1hFromParameter, price1hToParameter, price30minFromParameter, price30minToParameter, price15minFromParameter, price15minToParameter, priceAllNightFromParameter, priceAllNightToParameter, outCallsIdParameter);
        }
    
        public virtual ObjectResult<Advertisement> AdvertisementPagging(ObjectParameter totalPages, Nullable<int> pageNo, Nullable<int> pageSize, string sortColumn, Nullable<bool> isAsc, Nullable<int> categoryId, Nullable<int> cityId, Nullable<int> voivodeshipId, Nullable<int> ageFrom, Nullable<int> ageTo, Nullable<int> weightFrom, Nullable<int> weightTo, Nullable<int> heightFrom, Nullable<int> heightTo, Nullable<int> breastSizeFrom, Nullable<int> breastSizeTo, Nullable<bool> isEnglish, Nullable<bool> isGerman, Nullable<bool> isRussian, Nullable<int> price1hFrom, Nullable<int> price1hTo, Nullable<int> price30minFrom, Nullable<int> price30minTo, Nullable<int> price15minFrom, Nullable<int> price15minTo, Nullable<int> priceAllNightFrom, Nullable<int> priceAllNightTo, Nullable<int> outCallsId, MergeOption mergeOption)
        {
            var pageNoParameter = pageNo.HasValue ?
                new ObjectParameter("PageNo", pageNo) :
                new ObjectParameter("PageNo", typeof(int));
